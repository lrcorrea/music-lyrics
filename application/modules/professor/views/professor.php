...
<div id="gradient">
	<div id="pin">
		<form action="<?php echo base_url('professor/cadastrar'); ?>" method="POST" class="form">
            <input type="text" name="NOMEPROFESSOR" placeholder="Insira seu Nome" maxlength="255" required>
...
<script src="<?php echo base_url() . 'application/modules/professor/assets/js/professor.js?v=0.4'; ?>"></script>
</body>
</html>